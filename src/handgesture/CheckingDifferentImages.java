...
public class CheckingDifferentImages {
	public static String fromImage="C://temp//sample.jpg";
	public static String toImage="C://temp//images.jpg";
    ...
    public static int showDifference(BufferedImage im1, BufferedImage im2)
    {
        ...
        if(area>100){
	        try {
	            ...
	            ImageIO.write(resultImage, "PNG", new File("c:\\temp\\out"+no+".png"));
	        } catch (IOException ex) {
	            Logger.getLogger(CheckingDifferentImages.class.getName()).log(Level.SEVERE, null, ex);
	        }
        }
    ...
    public static void main(String args[])
    {
    	...
    	System.out.println(checkingDifferentImages.check());
    }
